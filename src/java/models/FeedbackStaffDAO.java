 ...
 * @author Quang
 */
public class FeedbackStaffDAO extends DBContext {
    
    PreparedStatement stm;
    ResultSet rs;

    // lấy top 4 đánh giá mới nhất
    public ArrayList<FeedbackStaff> getTop4Feedback() {
        ArrayList<FeedbackStaff> data = new ArrayList<>();
        try (PreparedStatement stm = connection.prepareStatement(
            ...
            while (rs.next()) {
                ...
                FeedbackStaff p = new FeedbackStaff(course, student, text, date);
                data.add(p);
            }
