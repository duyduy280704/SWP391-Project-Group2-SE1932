...
public class CourseDAO extends DBContext {
    ...
    public ArrayList<CourseType> getCourseType() {
        ArrayList<CourseType> data = new ArrayList<>();
        try {
            ...
            while (rs.next()) {
                ...
                CourseType c = new CourseType(code, name);
                data.add(c);
            }
        } catch (Exception e) {
    ...
    public ResultMessage update(Courses s) {
        ...
        try (PreparedStatement stm = connection.prepareStatement(
            ...
            stm.setDouble(4, fee);
            stm.setString(5, s.image != null ? s.image : ""); // Xử lý image null
    ...
    public ResultMessage add(Courses p) {
        ...
        try (PreparedStatement stm = connection.prepareStatement(
            ...
            stm.setDouble(4, fee);
            stm.setString(5, p.image != null ? p.image : ""); // Xử lý image null
            int rowsAffected = stm.executeUpdate();
            if (rowsAffected > 0) {
