...
public class TeacherApplicationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TeacherApplicationController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TeacherApplicationController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<TeacherApplicationType> data = ad.getTeacherApplicationTypeList();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Application a = new Application(null, teacherId, application, content, null, status);

        ResultMessage result = null;
        ApplicationDAO ad = new ApplicationDAO();
        if (request.getParameter("add") != null) {
            result = ad.addApplicationByTeacher(a);
        }
