    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (adminStaff != null) {
                ...
                System.out.println("Student RoleId: " + student.getRoleId());
                if ("1".equalsIgnoreCase(student.getRoleId())) {
                    url = STUDENT_PAGE;
                }
                request.setAttribute("successMessage", "Đăng nhập thành công!");
                ...
                System.out.println("Teacher RoleId: " + teacher.getRoleId());
                if ("2".equalsIgnoreCase(teacher.getRoleId())) {
                    url = TEACHER_PAGE;
                }
                request.setAttribute("successMessage", "Đăng nhập thành công!");
            } else {
