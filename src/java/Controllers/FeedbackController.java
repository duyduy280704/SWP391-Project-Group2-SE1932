...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (account instanceof Teachers && "viewAll".equals(mode)) {
        ...
        List<FeedbackByStudent> feedbackList = dao.getFeedbackByTeacher(teacher.getId());
        request.setAttribute("feedbackList", feedbackList);
    ...
    // Sinh viên xem lịch sử phản hồi
    ...
    // Nếu không đúng quyền hoặc mode nào thì báo lỗi quyền
    response.getWriter().println("<h3 style='color:red'>Bạn không có quyền truy cập chức năng này.</h3>");
}
