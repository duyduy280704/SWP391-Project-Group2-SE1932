...
public class SetBannerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SetBannerController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SetBannerController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String bannerId = request.getParameter("id2");

        if (request.getParameter("mode") != null && request.getParameter("mode").equals("3")) {
            //tìm Product tương ứng cùng với code truyền sang

            SetBanner s = sd.getSetBannerById(bannerId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Handle file upload
        Part filePart = request.getPart("anh2");
        ...
        SetBanner s = new SetBanner(id, tieude2, imageBytes);

        try {
            if (request.getParameter("update2") != null) {
                result = sd.updateBanner(s);
            } else if (request.getParameter("add2") != null) {
                result = sd.addBanner(s);
            } else {
