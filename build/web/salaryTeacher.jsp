...
<html lang="en">
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <a href="feedbackByTeacher" class="nav-link">Đánh giá sinh viên</a>
            <a href="salaryteacher" class="nav-link active">Bảng Lương</a>
            <a href="teacherapplication" class="nav-link">Gửi Đơn</a>
