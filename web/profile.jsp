                            ...
                            <form action="profile" method="post" enctype="multipart/form-data">
                                ...
                                <c:if test="${roleId == '2'}">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="expertise" value="${profile.course}" required oninvalid="this.setCustomValidity('Vui lòng điền vào đây')" oninput="this.setCustomValidity('')">
                                    </div>
                                    <div class="form-group">
                                        <label>Kinh Nghiệm (Năm):</label>
                                        <input type="number" name="yearsOfExperience" value="${profile.year}" required oninvalid="this.setCustomValidity('Vui lòng điền vào đây')" oninput="this.setCustomValidity('')">
                                    </div>
                                    <div class="form-group">
                                        <label>Ảnh Đại Diện:</label>
                                        <c:set var="picturePath" value="${not empty picturePath ? picturePath : sessionScope.picturePath}" />
