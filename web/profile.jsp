...
<body>
    ...
    <!-- Navbar End -->
     ...
     <div class="container">
                    ...
                    <c:when test="${not empty profile}">
                        <form action="profile" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="newPhone" value="${profile.phone}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="newPassword" id="newPassword" oninput="checkPasswordMatch()">
                            </div>
                            <div class="form-group">
        ...
        <div class="main-content">
            ...
            <div id="personalInfo" class="content active">
                <c:if test="${not empty message}">
                    <div class="message ${message.contains('thành công') ? 'success' : 'error'}">
                        ${message}
                    </div>
                        ...
                        <form action="profile" method="post" enctype="multipart/form-data">
                            ...
                            <c:if test="${role == 'student'}">
                                ...
                                <div class="form-group">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty profile.pic}">
                                            <img src="profile?mode=image&id=${profile.id}&role=${role}" alt="Profile Picture" class="profile-image">
                                        </c:when>
                                        <c:otherwise>
                                            <img src="img/default-avatar.jpg" alt="Default Avatar" class="profile-image">
                                        </c:otherwise>
                                    </c:choose>
                            ...
                            <c:if test="${role == 'teacher'}">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="expertise" value="${profile.exp}" required>
                                </div>
                                <div class="form-group">
    ...
    <script>
        ...
        function checkPasswordMatch() {
            ...
            const confirmPassword = document.getElementById('confirmPassword').value;
            const errorMsg = document.getElementById('passwordMatchError');
            errorMsg.style.display = newPassword !== confirmPassword ? 'block' : 'none';
        }
    </script>
</body>
</html>