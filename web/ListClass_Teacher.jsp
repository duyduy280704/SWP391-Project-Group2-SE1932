    ...
    <body>
        ...
        <div class="main-content">
            <div class="container mt-4">
                ...
                <form method="get" action="classStudent" class="search-container">
                    <input type="hidden" name="mode" value="teacherView" />
                    <input type="text" name="keyword" class="search-input" placeholder="Tìm tên lớp học..." value="${param.keyword}">
